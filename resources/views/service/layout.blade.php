...
<aside class="main-sidebar">
   ...
   <ul class="sidebar-menu">
      ...
      <li><a href="{{route('profile.show', Auth::user()->profile->id)}}"><i class="fa fa-list-ul"></i> <span>Профиль</span></a></li>
      <!-- <li><a href="/ceo/categories"><i class="fa fa-list-ul"></i> <span>Категории</span></a></li> -->
      <li><a href="#"><i class="fa fa-list-ul"></i> <span>Услуги</span></a></li>
      ...
      <li><a href="{{route('image')}}"><i class="fa fa-user-plus"></i> <span>Картинки</span></a></li>
